...
1. Python Software Foundation, *Python Documentation – Classes and Objects*: https://docs.python.org/3/tutorial/classes.html  
2. Python Software Foundation, *Python Documentation – Inheritance and Method Resolution Order*: https://docs.python.org/3/howto/mro.html  
3. Python Software Foundation, *Python Documentation – abc: Abstract Base Classes*: https://docs.python.org/3/library/abc.html
